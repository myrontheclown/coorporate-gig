...
class AppColors {
  ...
  // Duty status — used exclusively for the on-duty/off-duty toggle and badges
  static const Color dutyOn = Color(0xFF16A34A);   // Green-600 — worker is on duty
  static const Color dutyOnBg = Color(0xFFDCFCE7); // Green-100 background
  static const Color dutyOff = Color(0xFFDC2626);  // Red-600 — worker is off duty
  static const Color dutyOffBg = Color(0xFFFEE2E2); // Red-100 background
