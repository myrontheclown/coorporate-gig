...
class WorkerProfile {
  ...
  final bool isOnDuty;
  final DateTime? onDutyUpdatedAt;
  ...
  factory WorkerProfile.fromJson(Map<String, dynamic> json) {
    ...
    return WorkerProfile(
      ...
      onDutyUpdatedAt: json['on_duty_updated_at'] != null
          ? DateTime.tryParse(json['on_duty_updated_at'].toString())
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'is_on_duty': isOnDuty,
      if (onDutyUpdatedAt != null)
        'on_duty_updated_at': onDutyUpdatedAt!.toIso8601String(),
  ...
  WorkerProfile copyWith({
    ...
    return WorkerProfile(
      ...
      onDutyUpdatedAt: onDutyUpdatedAt ?? this.onDutyUpdatedAt,
      createdAt: createdAt ?? this.createdAt,
      userProfile: userProfile ?? this.userProfile,
      cooperativeProfile: cooperativeProfile ?? this.cooperativeProfile,
    );
  }
