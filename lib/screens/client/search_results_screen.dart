...
class _SearchResultsScreenState extends State<SearchResultsScreen> {
  ...
  Future<void> _fetchWorkers() async {
    try {
      // onDutyOnly: true — search results only surface workers who are on duty
      final list = await WorkerProfileService.getWorkers(onDutyOnly: true);
  ...
  List<Worker> get _base {
    // Mock fallback: only on-duty workers
    return _supabaseWorkers.isNotEmpty
        ? [..._supabaseWorkers]
        : [...MockData.onDutyWorkers];
  }
